...
const MainBanner = () => {
    return (
        <Flex className="container" 
            ...
            bgRepeat={'no-repeat'}
            bgSize={['90%', '65%', '60%', '50%']}
            padding={['160px 30px 200px 30px', '160px 50px 200px 50px', '180px 50px 80px 80px']}
            minH={'90vh'}
            marginTop={'-125px'}
            alignItems={'center'}
        >
            <Box w={['100%', '100%', '80%', '60%']}>
                <Heading as={'h1'} fontSize={['30px', '35px', '40px', '50px']}>¿Eres víctima o testigo de un caso de bullying?</Heading>
